...
\begin{exercise}
  ...
  (Eventuali espressioni formali possono essere espresse nel linguaggio naturale, \`e' sufficiente evitare ambiguit\`a.)
\end{exercise}
...
\begin{exercise}
  ...
  La definizione di ultraomogeneo nonm è stata data a lezione, va cercata nelle dispense.
\end{exercise}
