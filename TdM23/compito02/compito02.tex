...
\begin{exercise}
  ...
  (Basta descrivere senza troppi dettagli i tre modelli, senza dimostrazione)

  Per quale di questi modelli vale un lemma di estensione simile a quelli dimostrati in classe?
  \end{exercise}
