...
\begin{exercise}
Let $N$ consist of 3 copies of $\ZZ$ that share the same non negative part. The language has only a function symbol for the successor function (which will be non invertible in $0$).  Let $M$ be the substructure of $N$ obtained erasing one copy of $\ZZ$. 
\begin{itemize}
\item[1.] Prove that $M\not\equiv N$. 
