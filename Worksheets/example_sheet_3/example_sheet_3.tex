...
\begin{exercise}
Prove that a in  strongly minima theory every infinite algebraically closed set is a model.
\end{exercise}

\begin{exercise}
Prove that a countable strongly minima theory is either $\omega$-categorical or has infinitely many countable models.
\end{exercise}
