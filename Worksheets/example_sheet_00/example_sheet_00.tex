...
\item[2.] Prove every model countable model containing $n$ classs with $n$ elements for each $n\in\omega\sm\{0\}$ and infinitely many infinite classes is saturated.
