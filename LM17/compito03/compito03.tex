...
\begin{exercise}
Prove that for every $b\in N\models T_{\rm rg}$ the set $r(b,N)$ is a random graph. Assume $N$ is countable. Is every random  graph $M\subseteq N$ of the form $r(b,N)$ for some $b\in N$~? (Suggerimento: per la seconda domanda si usi l'esercizio precedente.)
\end{exercise}
\end{document}
