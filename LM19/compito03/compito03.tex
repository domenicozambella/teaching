...
\end{itemize}
Use the result to prove that if $T$ complete and partial isomorphisms between models of $T$ preserve the truth of all formulas then $T$ has elimination of quantifiers.
\end{exercise}
