...
\begin{document}
\begin{exercise}
  Sia $G$ un grafo bipartito di densità $\alpha$ con insiemi di vertici $A$ e $B$. Dimostrare che il numero di quadruple $(x_1,y_1,x_2,y_2)$ che formano un percorso circolare, è al meno $\alpha^4|A|\,|B|$.
\end{exercise}
\end{document}
