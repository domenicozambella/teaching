...
\begin{exercise}
  ...
  Prove that if $\bar\D$ is a sequence of indiscernibles over $A$ in $\U^\eq$, then there is a sequence of $A$-indiscernibles $\bar b=\<\bar b_n: n<\omega\>$ such that $\bar\D_n=\sigma(\U^x\,;b_n)$.
\end{exercise}
