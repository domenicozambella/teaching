...
\begin{exercise}
  Prove (for the pair of statements of your choice) that that the following are equivalent for every $X\subseteq\RR$.
...
\end{exercise}
  For what sets $X\subseteq\RR$ the following holds?
  \begin{itemize}
