...
\begin{exercise}
  ...
  \begin{itemize}
    ...
    \item[2.] Can we axiomatize their theory $T_1$? 
    \item[3.] If so, does $T_1$ have elimination of quantifiers? 
...
\begin{exercise}
  ...
  \begin{itemize}
  \item[1.] Do $\omega$-rich models of $T_0$ exist~?  If so, let $T_1$ be the set of sentences that hold in all rich model.
  \item[2.] Does $T_1$ has elimination of quantifiers~?
  \item[3.] Is $T_1$ $\omega$-categorical~? 
  \end{itemize} 
