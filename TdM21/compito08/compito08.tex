...
\begin{exercise}
  ...
  %
  Prove that for every finite coloring of the edges of $M$, there is an infinite monochromatic complete subgraph.
\end{exercise}

%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{exercise}
  Chi vuole, in alternativa, pu\`o provare la seguente versione pi\`u generale dell'esercizio~1.

  Let $M$ be as in the exercise above.
  %
